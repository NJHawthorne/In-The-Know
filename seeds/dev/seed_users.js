			...
			return Promise.join(
				...
				.then(pageId => {
					...
					return Promise.join(
					    ...
					    knex('buttons').insert({ createdAt: date, position: 3, buttonName: 'Targaryen', question: 'What was the name of the dragon Danaerys rode away on?', answer: 'drogon',pageId: 1, icon: 'fa-fire', color: 'red', posTop: 53, posLeft: 67, imageUrl: 'http://winteriscoming.net/wp-content/uploads/2016/02/House-Targ.-Game-of-Thrones-810x569.jpg'}),
					    ...
					    knex('buttons').insert({ createdAt: date, position: 6, buttonName: 'Dothraki', question: 'Who was the Khal who married Danaerys in season one?', answer: 'drogo', pageId: 1, icon: 'fa-ship', color: 'brown', posTop: 60, posLeft: 80, imageUrl: 'http://getinmedia.com/sites/default/files/images/Dothraki%20Inline.jpg'})
					);
				})
			);
		});
			...
			return Promise.join(
				...
				.then(pageId => {
					...
					return Promise.join(
					    ...
					    knex('buttons').insert({ createdAt: date, position: 3, buttonName: 'Targaryen', question: 'What was the name of the dragon Danaerys rode away on?', answer: 'drogon',pageId: 2, icon: 'fa-fire', color: 'red', posTop: 53, posLeft: 67, imageUrl: 'http://winteriscoming.net/wp-content/uploads/2016/02/House-Targ.-Game-of-Thrones-810x569.jpg'}),
					    ...
					    knex('buttons').insert({ createdAt: date, position: 6, buttonName: 'Dothraki', question: 'Who was the Khal who married Danaerys in season one?', answer: 'drogo', pageId: 2, icon: 'fa-ship', color: 'brown', posTop: 60, posLeft: 80, imageUrl: 'http://getinmedia.com/sites/default/files/images/Dothraki%20Inline.jpg'})
					);
				})
			);
		})
			...
			return Promise.join(
				...
				.then(pageId => {
					...
					return Promise.join(
					    ...
					    knex('buttons').insert({ createdAt: date, position: 3, buttonName: 'Targaryen', question: 'What was the name of the dragon Danaerys rode away on?', answer: 'drogon',pageId: 3, icon: 'fa-fire', color: 'red', posTop: 53, posLeft: 67, imageUrl: 'http://winteriscoming.net/wp-content/uploads/2016/02/House-Targ.-Game-of-Thrones-810x569.jpg'}),
					    ...
					    knex('buttons').insert({ createdAt: date, position: 6, buttonName: 'Dothraki', question: 'Who was the Khal who married Danaerys in season one?', answer: 'drogo', pageId: 3, icon: 'fa-ship', color: 'brown', posTop: 60, posLeft: 80, imageUrl: 'http://getinmedia.com/sites/default/files/images/Dothraki%20Inline.jpg'})
					);
				})
			);
		});
